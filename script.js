...
data.forEach(course=>{
    const imageCard=document.getElementById('div');
    ...
    shortDesc.innerText=course.ShortDesc;


    const viewButton=document.createElement('div');
    viewButton.classList.add('read-more-button');
    ...
    courseinfo.appendChild(shortDesc);
    courseinfo.appendChild(viewButton);

    imageCard.appendChild(image);
    imageCard.appendChild(courseinfo);
